...
*/
    ...
    void mockRequestAndResponse(String mockResponseResourceName, int responseStatus, TxnProxy consumerPostApprovalTxnProxy) {
        ...
        AtomicCreateAccessTokenPaymentSwitchRequest request = new AtomicQuery(logger, dashboardTxnProxy).buildCreateAccessTokenPaymentSwitchRequest(products, existingAccountsMap, existingAccountsMap)
