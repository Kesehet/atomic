...
class AtomicGetAccessTokenFluentFunction extends FnbBaseFluentFunction {
    ...
    FuncResult run(FuncParam param) {
        ...
        accessToken = accessTokenManager.getAccessTokenFromAtomicDds(consumerDepositProductsDDSEligible, existingAccountsList, TXN_PROP_SERVICE_PREFIX, formProductsAcctMap)
